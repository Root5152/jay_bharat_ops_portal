                    ...
                    <div className='mt-16 flex lg:mb-[10rem] '>
                        <div>
                            ...
                            <Table>
                                ...
                                <TableHeader>
                                    <TableRow>
                                        <TableHead className=" w-[20rem] border-2 pl-5 text-[1rem] font-inter ">Client Name</TableHead>
                                        <TableHead className=" w-[10rem]  border-2 pl-4 text-[1rem] font-inter ">Client Ref No</TableHead>
                                        <TableHead className=" w-[18rem] border-2 pl-5 text-[1rem] font-inter ">Actions</TableHead>
                                    </TableRow>
                                </TableHeader>
                                ...
                                {data.map((item) => (
                                    <TableBody key={item.id} className="border-2">
                                        <TableRow className="h-[3rem] ">
                                            <TableCell className="font-inter pl-4 w-[20rem] ">{item.client_name}</TableCell>
                                            <TableCell className="border pl-4 font-inter  w-[20rem]">{item.client_ref}</TableCell>

                                            <TableCell className="flex ml-4 w-[20rem]">

                                                <AlertDialog>
                                                    <AlertDialogTrigger className=''>
                                                        <Button className="  w-[5rem] h-[2rem] font-inter bg-gray-700 text-white rounded-lg ml-4"> Edit</Button>
                                                       </AlertDialogTrigger>
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                ...
                                                <AlertDialog>
                                                    <AlertDialogTrigger >
                                                        <Button   className="  w-[5rem] h-[2rem] font-inter bg-red-700 text-white rounded-lg ml-4">Delete</Button>
                                                    </AlertDialogTrigger>
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
